...
Il calcolo delle ore di lavoro (riportato in \ref{d4:distribuzione_ore}) è stato tenuto aggiornato in ogni fase della realizzazione segnandole su un foglio di lavoro condiviso su Fogli Google, che si è poi evoluto in una bacheca in cui annotare anche idee e task da svolgere.
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{10em}|p{10em}|p{22em}|}
        ...
        &
        Ha realizzato le user stories, l'analisi e il diagramma dei componenti, il design del Frontend e il report finale. Ha svolto diversi lavori di revisione e correzione della documentazione, specialmente del D1. \\
        \hline
    \end{tabular}
\end{table}
\noindent
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \textbf{Voto}  \\
        \hline
        \textit{D'Angiò Enea} & 254088 & 30L \\
        \hline
        \textit{Nedeljkovic Ivan} & 255329 & 30L \\
        \hline
        \textit{Mattarolo Alessandro} & 254087 & 30L \\
        \hline
    \end{tabular}
\end{table}
