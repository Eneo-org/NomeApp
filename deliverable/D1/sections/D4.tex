...
Viene qui riportata una tabella che descrive i principali ruoli dei componenti del gruppo.
\newline
\begin{table}[H]
    \centering
...
\subsection{Carico e distribuzione del lavoro} \label{d4:distribuzione_ore}
