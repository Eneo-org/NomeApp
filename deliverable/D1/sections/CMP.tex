...
Il componente funge da intermediario tra il database e il componente "Gestione creazione iniziative" (CMP\ref{cmp:creazione_iniz}). Gestisce il controllo duplicati di cui si parla in RF\ref{rf:controllo_duplicati}. 
\paragraph{Interfacce richieste:}
\begin{itemize}
    \item \textbf{Lista iniziative in corso:} lista delle iniziative nel database che risultano in corso.
...
\begin{itemize}
    ...
    \item \textbf{Conferma di assenza di bilanci partecipativi in corso:} conferma dal database riguardo l'assenza di bilanci partecipativi già in corso.
...
\begin{itemize}
    ...
    \item \textbf{Iniziative salvate:} lista delle iniziative nel database di cui l'utente segue l'avanzamento.
...
\begin{itemize}
    ...
    \item \textbf{Visualizzazione iniziative salvate:} visualizzazione grafica della lista di iniziative di cui l'utente segue lo stato d'avanzamento.
...
Il componente si occupa di gestire l'invio di notifiche sulla dashboard personale dell'utente e via e-mail nei casi riportati in RF\ref{rf:notifiche}.
\paragraph{Interfacce richieste:}
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Conferma di assenza di bilanci partecipativi in corso:} conferma dell'assenza di un bilancio partecipativo in corso nel database, inviata al componente "Gestione creazione bilanci partecipativi" (CMP\ref{cmp:creazione_bp}).
