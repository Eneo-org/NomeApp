...
\begin{itemize}
    ...
    \item \textbf{RF\ref{rf:voto}: Votazione del bilancio partecipativo -} All'interno della pagina è visibile il bilancio partecipativo attualmente in corso, con tanto di data di scadenza e opzioni. Il cittadino autenticato sarà in grado di interagire con esso selezionando una delle opzioni votabili. Se l'utente non è autenticato o non ha privilegi da cittadino, i pulsanti per selezionare le opzioni sono disabilitati.
\end{itemize}
