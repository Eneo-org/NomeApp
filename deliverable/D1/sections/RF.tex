...
La pagina di dettaglio deve mostrare tutte le informazioni associate all'iniziativa, organizzate in modo chiaro. In particolare:

\begin{itemize}
    \item \textbf{Dati della proposta:}
    \textbf{titolo},
    \textbf{descrizione} completa,
    \textbf{autore} (se l'iniziativa è creata in piattaforma),
    \textbf{categoria} di appartenenza (es. "ambiente", "mobilità"),
    \textbf{luogo} (se specificato),
    ...
    \textbf{numero totale di firme raccolte} (aggiornato in tempo reale se l'iniziativa è interna),
     \textbf{data di scadenza} (per le iniziative non importate nello stato "In corso"),
    \textbf{piattaforma di provenienza} (se l'iniziativa è importata).
...
\subsubsection{Requisiti funzionali per l’amministrazione}
...
\subsubsection{Requisiti funzionali per i cittadini autenticati}
...
\RNF{Compatibilità.}  \label{rf:login}
...
\RNF{Affidabilità e disponibilità.}  \label{rnf:aff_e_fisponibilita}
