...
\begin{itemize}
    ...
    \item \textbf{Conferma di esistenza del profilo:} flag di conferma dell'esistenza dell'utente nel database, in modo da distiguere la promozione di un cittadino già registrato da una pre-autorizzazione.
